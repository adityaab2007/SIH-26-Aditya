...
def _run_with_adaptive_forward_oof(output_dir) -> None:
            ...
            try:
                ...
                if available < 20:
                    raise RuntimeError(
                        ...
                        "Exp125 requires at least 20 for an experiment-local adaptive calibration gate."
                    ) from exc
    ...
    if reductions:
        print(
            "EXP125_OOF_AFT_GATE_ADAPTATIONS="
...
def main() -> None:
    ...
    p.add_argument("--output-dir", default="models/monthly_lifecycle/experiments/exp125/ci")
