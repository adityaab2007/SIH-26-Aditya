...
export const api = {
  ...
  simulationProjects: (version) => request(`/api/model-simulations/${encodeURIComponent(version)}/projects`),
  runSimulation: (version, recordIndex = null) => request(`/api/model-simulations/${encodeURIComponent(version)}/run`, { method: 'POST', headers: JSON_HEADERS, body: recordIndex === null ? undefined : JSON.stringify({ record_index: Number(recordIndex) }) }),
